...
def fused_dense_func(
    ...
    is_using_cuda = (internlm_accelerator.get_accelerator_backend() in [AcceleratorType.GPU, AcceleratorType.DIPU]) and dtype_eligible
...
def try_import_RMSNorm():
    ...
    try:
        ...
        if device_backend == AcceleratorType.DIPU:
            from deeplink_ext.internlm_ops.rms_norm import DeepLinkRMSNormWithNormalizedShape as RMSNorm
