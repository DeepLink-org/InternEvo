...
SAVE_CKPT_FOLDER = f"/mnt/lustrenew/shanhang/dataset/llama2_hf_printfused_save"
...
MODEL_ONLY_FOLDER = "/mnt/lustrenew/share_data/PAT/datasets/llama2/Llama-2-70b-hf"
CHECKPOINT_EVERY = 50
ckpt = dict(
...
TRAIN_FOLDER = "/mnt/cache/shanhang/newhome/project/InternEvo/train"
VALID_FOLDER = "/mnt/cache/shanhang/newhome/project/InternEvo/valid"
USE_FA = True
data = dict(
    seq_len=SEQ_LEN,
