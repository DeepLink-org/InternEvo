...
MODEL_ONLY_FOLDER = "/data/datasets/2layers-checkpoint-intern"
# Ckpt folder format:
# fs: 'local:/mnt/nfs/XXX'
SAVE_CKPT_FOLDER = f"/data/shanhang/workspace/InternEvo/save"
...
TRAIN_FOLDER = "/data/xuqiang/llama2_train_70b/alpaca/train"
VALID_FOLDER = "/data/xuqiang/llama2_train_70b/alpaca/valid"  # "/path/to/dataset"
USE_FA = False
data = dict(
    seq_len=SEQ_LEN,
